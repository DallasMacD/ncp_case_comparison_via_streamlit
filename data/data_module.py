...
def select_cases():
	...
	case_directory_dict = {fr'Case 1\Jan\1941': fr'{os.path.dirname(os.path.dirname(__file__))}\NCP Cases\Case 1\Jan\1941',
				fr'Case 2\Jan\1941': fr'{os.path.dirname(os.path.dirname(__file__))}\NCP Cases\Case 2\Jan\1941',
				fr'Case 3\Jan\1941': fr'{os.path.dirname(os.path.dirname(__file__))}\NCP Cases\Case 3\Jan\1941',
				fr'Case 4\Jan\1941': fr'{os.path.dirname(os.path.dirname(__file__))}\NCP Cases\Case 4\Jan\1941',
				fr'Case 5\Jan\1941': fr'{os.path.dirname(os.path.dirname(__file__))}\NCP Cases\Case 5\Jan\1941'}
