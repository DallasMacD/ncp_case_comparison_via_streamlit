...
subprocess.Popen('streamlit run ' + '"' + cwd + '\\0_🏠_Home.py" --theme.base="light" --theme.primaryColor="#0079C1" --theme.backgroundColor="#FFFFFF" --theme.secondaryBackgroundColor="#E5F5FD" --theme.textColor="#262730" --theme.font="sans serif" --server.headless true', shell=True)
